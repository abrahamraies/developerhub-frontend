...
const Sidebar = () => {
  ...
  return (
    <aside className="flex flex-col bg-white/70 dark:bg-gray-800/70 backdrop-blur-md border-r border-white/20 dark:border-gray-700 shadow-lg w-64 min-h-screen fixed inset-y-0 left-0 z-30 md:flex">
      <div className="flex items-center space-x-2 px-6 py-5 border-b border-white/20 dark:border-gray-700">
